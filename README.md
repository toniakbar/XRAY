...
🚀  Ubuntu 18.04 & 20.04 Only For First Time Installation (Update Repo) 🚀<br> 
  ...
  ```html
sudo apt update -y && sudo apt upgrade -y  && apt dist-upgrade -y && update-grub && reboot
 ```
<br>
<h2 align="center">
🚀 Installation Script By Digital-Net 🚀<br>
  ...
  ```html
bash <(wget -qO- https://raw.githubusercontent.com/toniakbar/XRAY/lite/main.sh)
  ```
...
<h2 align="center"> 
</p> <img src="https://i.postimg.cc/QCsLNbX2/lite.png"><br>
